      ...
      <div className="max-w-md w-full">
        <div className="bg-white shadow-sm border border-gray-200 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/"
              className="flex-1 block py-3 rounded-full border border-gray-200 text-gray-500 hover:text-gray-900 hover:border-[#7C3AED] font-semibold text-sm text-center transition-colors"
            >
              Back to Home
            </Link>
          </div>
