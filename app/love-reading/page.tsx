...
export const metadata: Metadata = {
  ...
  description:
    "Korean Four Pillars (Saju) reveals your love personality, ideal partner type & romantic timing. Get a personalized love report from a certified master for only $19.",
  keywords: [
    "saju love reading",
